...
```
## 6.2. Ссылка изображения
Все работает точно также сочетание квадратных скобок + круглые скобки
```
![То что выводится при наведении на изображение](https://avatars.githubusercontent.com/u/57312267?v=4)
```
![То что выводится при наведении на изображение](https://avatars.githubusercontent.com/u/57312267?v=4)
[К оглавлению](#Оглавление)
____
