...
7. [Рисунок](#Рисунок)
     * 7.1. Картинки из интернета
     * 7.2. Изображения в репозитории GitHub
...
отображения таких изображений необходимо указать относительный адрес Вашего файла в репозитории, например у мена в 
папке media находится изображения с названием super.jfif, для отображения необходимо ввести
```
![](./media/super.jfif)
```
![](./media/super.jfif)
